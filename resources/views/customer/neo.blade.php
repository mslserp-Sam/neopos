                ...
                <div class="card card-block card-stretch">
                    <div class="card-body p-0">
                        <div class="d-flex justify-content-between align-items-center p-3 flex-wrap gap-3">
                            <h5 class="font-weight-bold">{{ 'All Neo List' ?? trans('All Neo List') }}</h5>
                            @if($auth_user->can('user add'))
                            <a href="{{ route('user.create_neo') }}" class="float-right mr-1 btn btn-sm btn-primary"><i class="fa fa-plus-circle"></i> {{ __('messages.add_form_title',['form' => __('Neo')  ]) }}</a>
                            @endif
                        </div>
                    </div>
                </div>
